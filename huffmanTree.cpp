...
{
cout<<root->ch<<" := "<< root->freqInfo<<" == "<<root->code<<endl;
}
...
{
cerr<<"Error in creating either "<<file_name<<"or encoded_file.dat file!!"<<endl;
return;
}
else
{
...
int arr[256];// arr to hold the frequency of the characters occured in the word
...
vector<Node*> freqList;// vector pointer to store the frequencies of characters in a file
